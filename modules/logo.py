...
{red} If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print (f'''
{yellow}    [ + ] {green}Dig-Up installed successfully.
{yellow}    [ + ] {green}To run Dig-Up,
{yellow}    [ + ] {green}Type Dig-Up in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print (f'''
{yellow}  [ 1 ] {green}Update your Dig-Up.
{yellow}  [ 0 ] {green}For Back.{nc}''')
  ...
  def updated(self):
    self.tool_header()
    print (f'''
{yellow}      [ + ] {green}Dig-Up Updated Successfully.
...
{cyan}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def update_error(self):
    self.tool_header()
    print (f'''
{red}  [ + ]  {red}We can't Update Dig-Up.\033[1;m
{red}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
{yellow}       [+] Tool Name :- {green}Dig-Up
{yellow}       [+] Latest Update :- {green}17/12/2021.\033[1;m
{yellow}       [+] Tools :- {green}total {total} tools.\033[1;m

{yellow} [+] {green}Dig-Up is automatic tool installer.
{yellow} [+] {green}Made for linux based system.
...
{yellow}|  00) Back                                   |
 \033[01;36m============================================={nc}""")
  ...
  def updating(self):
    print (f"""{yellow} =============================================
{green}|______________ Updating Dig-Up ______________|
 {yellow}============================================={nc}""")
...
{yellow}  [ x ] {green}For Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print (f'''
{yellow}         [ + ] {green}Thanks for using Dig-Up
